...
time I visit, I recommend others to avoid."""
    ...
    splitter = Splitter()
    postagger = POSTagger()
    dicttagger = DictionaryTagger([ 'F:\Research Folder 1\lesson2\positive.yml', 'F:\Research Folder 1\lesson2\negative.yml',
                                    'F:\Research Folder 1\lesson2\inc.yml', 'F:\Research Folder 1\lesson2\dec.yml', 'F:\Research Folder 1\lesson2\inv.yml'])
